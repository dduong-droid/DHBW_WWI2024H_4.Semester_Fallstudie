# Roadmap Uebersicht: Food 4 Recovery

## Gemeinsamer Produktfokus

Food 4 Recovery wird fuer die Abgabe als digitale Ernaehrungsnachsorge nach der Entlassung positioniert. Der Kern ist nicht ein allgemeiner Health-Shop und nicht ein KI-Arzt, sondern ein strukturierter Nachsorge-Flow:

**Intake -> Risiko-Check -> 7-Tage-Ernaehrungsplan -> Einkaufsliste/Meal-Kits -> Tracking -> Review/Analytics**

Die Loesung soll Patientinnen und Patienten sowie Angehoerige nach der Entlassung konkret unterstuetzen: Was kann gegessen werden, was sollte vermieden werden, was muss beobachtet werden und wann ist fachliche Ruecksprache sinnvoll?

## Zielgruppe und Rollen

- **Primaere Zielgruppe:** postoperative Patientinnen und Patienten nach Entlassung
- **Sekundaere Zielgruppe:** Angehoerige, die Einkauf, Kochen und Alltagsorganisation unterstuetzen
- **Fachliche Rolle:** Ernaehrungsberatung oder medizinisches Fachpersonal fuer kritische Faelle
- **Zugangskanal:** Klinik, Praxis, Ernaehrungsberatung oder Versicherung im B2B2C-Modell
...
2. Intake-Fragebogen erfasst medizinischen Kontext, Beschwerden, Allergien, Appetit, Gewicht, Kochmoeglichkeiten und Ziele.
...
6. Kritische Faelle werden fuer eine professionelle Pruefung sichtbar.
...
| --- | --- | --- |
| Dev1 | Frontend und Patient Journey | Macht den Flow klickbar, verstaendlich und praesentationsreif. |
| Dev2 | Backend/API und Fachlogik | Liefert Daten, Persistenz, Privacy, Safety, Planlogik und interne APIs. |
| Dev3 | Business Case, Doku und Praesentation | Schaerft Zielgruppe, Nutzen, Risiken, Roadmap und Abgabeartefakte. |

## Gemeinsamer Demo-Flow

Fuer die Abgabe sollte das Team denselben Flow zeigen:
...
9. Tracking von Appetit, Gewicht, Mahlzeiten oder Fluessigkeit
...
## Erfolgskriterien fuer die Abgabe
...
- Die wichtigsten Artefakte liegen im Repo und sind fuer die Praesentation nutzbar.
