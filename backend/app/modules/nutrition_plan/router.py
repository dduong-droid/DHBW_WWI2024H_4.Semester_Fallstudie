...
from app.modules.nutrition_plan.service import (
    create_nutrition_plan_for_patient,
...
@router.post("/patients/{patient_id}/nutrition-plan", response_model=NutritionPlan)
def create_patient_plan(patient_id: str) -> NutritionPlan:
    return create_nutrition_plan_for_patient(patient_id)


@router.get("/patients/{patient_id}/nutrition-plan", response_model=NutritionPlan)
def get_patient_plan(patient_id: str) -> NutritionPlan:
