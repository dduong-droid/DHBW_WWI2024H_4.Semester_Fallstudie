...
_CURATED_LIBRARY: dict[str, list[dict[str, object]]] = {
    "post_op_high_protein": [
        {
            ...
            "description": "Eine proteinschwere Option für Gewebeaufbau, Wundheilung und stabile Erholung.",
            "tags": ["Protein", "Regeneration"],
            "ingredients": ["Hähnchenbrust", "Quinoa", "Brokkoli"],
        },
        {
            "id": "cur-po-002",
            "title": "Omega-3 Lachs Teller",
            "medicalBenefit": "Entzuendungsarm + Zellschutz",
            "description": "Unterstützt die postoperative Stabilisierung mit Eiweiß und Omega-3-Fettsaeuren.",
        ...
        },
        {
            ...
            "medicalBenefit": "Snack für Zwischenziele",
    ...
    "chemo_easy_digest": [
        {
            ...
            "description": "Reduziert die Essenshürde bei Appetitmangel und belastet den Magen wenig.",
        ...
        },
        {
            ...
            "description": "Warme, sanfte Komponenten für sensible Tage während einer belastenden Therapiephase.",
            "tags": ["Warm", "Sanft"],
        ...
        },
        {
            ...
            "description": "Snack-orientierte Energiezufuhr für Tage mit sehr geringer Essmenge.",
    ...
    "gut_balance_recovery": [
        {
            ...
            "description": "Sehr milde Basis für Tage, an denen Verträglichkeit wichtiger ist als Vielfalt.",
        ...
        },
        {
            ...
            "description": "Proteinversorgung ohne unnötige Belastung für eine empfindliche Verdauung.",
            "tags": ["Protein", "Leicht"],
    ...
    "energy_rebuild": [
        ...
        },
        {
            ...
            "description": "Verbindet Energiedichte mit einer klaren Eiweißquelle für schwache Phasen.",
            "tags": ["Alltag", "Protein"],
    ...
    "balanced_general_recovery": [
        {
            ...
            "medicalBenefit": "Basis für allgemeine Regeneration",
            "description": "Ein solider, breit verträglicher Ausgangspunkt für den Alltag in der Genesung.",
        ...
        },
        {
            ...
            "medicalBenefit": "Verträglichkeit + Struktur",
            "description": "Unterstützt regelmäßige Mahlzeiten ohne unnötig komplexe Zubereitung.",
            "tags": ["Mild", "Alltag"],
